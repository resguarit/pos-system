...
const EditBranchDialog = ({ open, onOpenChange, branch }: EditBranchDialogProps) => {
  const [editedBranch, setBranch] = useState<Branch>(branch || { id: '', name: '', address: '', phone: '', estado: 'Activo' });
