...
const RECEIPT_TYPE_STYLES_BY_CODE: Record<string, ReceiptTypeBadgeStyle> = {
  ...
  [ARCA_CODES.NOTA_CREDITO_A]: { bg: 'bg-rose-50', text: 'text-rose-700', border: 'border-rose-300' },
  [ARCA_CODES.NOTA_CREDITO_B]: { bg: 'bg-rose-50', text: 'text-rose-700', border: 'border-rose-300' },
  [ARCA_CODES.NOTA_CREDITO_C]: { bg: 'bg-rose-50', text: 'text-rose-700', border: 'border-rose-300' },
  ...
  '053': { bg: 'bg-rose-50', text: 'text-rose-700', border: 'border-rose-300' },
