    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/dashboard" element={<LayoutDashboard />}>
          ...
          {features.inventario && <Route path="inventario/:id/trazabilidad" element={<ProtectedRoute permissions={['ver_trazabilidad_producto']}><ProductTraceabilityPage /></ProtectedRoute>} />}
