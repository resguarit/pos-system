...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'ver_trazabilidad_producto', 'description' => 'Ver trazabilidad del producto', 'module' => 'productos'],
            ['name' => 'ver_stock_columna', 'description' => 'Ver columna de stock en listados de productos', 'module' => 'productos'],
            ...
            ['name' => 'ver_categorias_equipos', 'description' => 'Ver categorías de equipos', 'module' => 'reparaciones'],
            ['name' => 'crear_categorias_equipos', 'description' => 'Crear categoría de equipo', 'module' => 'reparaciones'],
            ['name' => 'editar_categorias_equipos', 'description' => 'Editar categoría de equipo', 'module' => 'reparaciones'],
            ['name' => 'eliminar_categorias_equipos', 'description' => 'Eliminar categoría de equipo', 'module' => 'reparaciones'],
